...
/*   Updated: 2023/12/14 18:32:50 by aalfahal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	ShrubberyCreationForm::execute(Bureaucrat const & executor) const {
	...
	if (outfile.good())
	{
		...
		outfile << "     /\\   | |                      | |     /\\   | |/ _|    | |         | |		" << std::endl;
		outfile << "    /  \\  | |__  _ __ ___   ___  __| |    /  \\  | | |_ __ _| |__   __ _| |		" << std::endl;
		outfile << "   / /\\ \\ | '_ \\| '_ ` _ \\ / _ \\/ _` |   / /\\ \\ | |  _/ _` | '_ \\ / _` | |	" << std::endl;
		outfile << "  / ____ \\| | | | | | | | |  __/ (_| |  / ____ \\| | || (_| | | | | (_| | |		" << std::endl;
		outfile << " /_/    \\_\\_| |_|_| |_| |_|\\___|\\__,_| /_/    \\_\\_|_| \\__,_|_| |_|\\__,_|_|	" << std::endl;
	}
	return (true);
}